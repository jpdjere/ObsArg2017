	...
	app.directive('d3Directive',function(){ //Lineas y rectangulos
		...
		function link(scope, element, attr){
			...
			var createGraphFunction = function(datos,containerSVG,pestania){
				...
				if(pestania === 13 || pestania === 8 || pestania === 12 || pestania === 13){
					...
					ajusteYpartido = 17;
					tamTexto = 18;
				}else if( pestania === 3 || pestania === 5 || pestania === 6 || pestania === 7 || pestania === 10 || pestania === 11){
				...
				.selectAll("rect")
				    ...
				    .attr("width", function(d){
				    	return transTopxAncho(4*d.desvPROY,d.promPROY-2*d.desvPROY); //Tiene un ancho de 4 DSTD, ajuste de funcion resto 390
				    ...
				    .attr("x", function(d){
				    	return transTopx(d.promPROY-2*d.desvPROY);
				    })
				...
				container.append("g")//.attr("transform","translate(0,-50)")
					...
					.attr("fill","white")
					.attr("cx",function(d){
						return transTopxAnchoCirculos(d.promPROY,d.promPROY-2*d.desvPROY);
					})
	...
	/*
				...
				function mousemoveTooltip(position, cand_i, prom_i, desv_i) {
					  ...
					  textTooltip
					    ...
					    .text(function(){
					    	if(cand_i === 'Otros'){
					    		return "Otros candidatos obtiene entre "+lowerLimTooltip.toFixed(2)+"% y "+upperLimTooltip.toFixed(2)+"% de los votos con un 95% de probabilidad y obtienen un promedio de "+promTooltip+"% de los votos.";
					    		...
					    		return cand_i+" obtiene entre "+lowerLimTooltip.toFixed(2)+"% y "+upperLimTooltip.toFixed(2)+"% de los votos con un 95% de probabilidad y obtiene un promedio de "+promTooltip+"% de los votos.";
					    	}
					    })
